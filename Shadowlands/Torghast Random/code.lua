    ...
    rotations = {
            ...
            function handle_purges(spell)
                ...
                if (purge_cd == 0) then
                    for i = 1, 40 do
                        ...
                        if (name) then
                            debug_msg(debug_purges, ' Purgable Found: '.. tostring(name) .. ' type :'..tostring(type))
        ...
        prepare = function(env)
            ...
            elseif player_class == 'MAGE' then
                ...
                if
                    (need_to_eat(env) or do_i_need_buffing(env, self_buff) or does_healer_need_mana(env) or is_anyone_dead(env) or
